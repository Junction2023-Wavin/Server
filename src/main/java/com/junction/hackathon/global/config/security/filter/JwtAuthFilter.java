package com.junction.hackathon.global.config.security.filter;
...
import com.junction.hackathon.global.config.security.jwt.JwtExceptionList;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException, JwtException {
        ...
        try {
            if (StringUtils.hasText(token) && tokenUtil.verifyToken(token)) {
                ...
                log.debug("Security Context에 '{}' 인증 정보를 저장했습니다, uri: {}", member.getEmail(), requestURI);
            }
